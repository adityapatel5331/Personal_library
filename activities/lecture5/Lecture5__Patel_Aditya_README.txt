...
1) This is the readme file for l5 activity submission.
As directed this txt file contains all the necessary documentations for L5. Some contents and ideas , about the use of elements and different tags are taken from l5 folder which was used for explanation for CSCI2170. 
...
I have not added or modified the calculator.php file much.
I have just added a simple function to check the value of number1 i.e Even or Odd.
